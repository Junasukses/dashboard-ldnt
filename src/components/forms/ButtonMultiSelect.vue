          ...
          >
            <template #header>
              ...
              <div
                ...
                class="mx-2 hover:underline hover:underline-blue-600 hover:text-blue-600 cursor-pointer animated animate-flip-in-x animate-delay-150 select-none"
              >
              ...
              <button
                v-if="!props.overrideHeader && selectedRows.length"
                class="transition-all duration-200 bg-white text-blue-500 rounded py-1 px-2 select-none"
                :class="{
                  'hover:!bg-blue-500 hover:text-white hover:shadow-sm)': selectedRows.length > 0,
