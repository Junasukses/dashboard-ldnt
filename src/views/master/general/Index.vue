...
const landing = reactive({
  ...
  api: {
    ...
    params: {
      simplest: true,
      searchfield:
        'this.id, this.code, this.group, this.value1, this.value1, this.all_bu, m_bu.name, this.is_active'
    },
    onsuccess(response) {
  ...
  columns: [
    ...
    {
      field: 'all_bu',
      headerName: 'Semua Business Unit',
      filter: true,
      filter: 'ColFilter',
      sortable: true,
      ...
      cellRenderer: ({ value }) => {
        return value === true
          ...
          : `<span class="text-gray-500 rounded-md text-xs font-medium px-4 py-1 inline-block capitalize">Tidak</span>`
      }
    },
    {
      field: 'group',
