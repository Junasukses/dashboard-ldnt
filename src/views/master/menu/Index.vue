...
const landing = reactive({
  ...
  api: {
    ...
    params: {
      simplest: true,
      searchfield:
        'this.id, m_bu.name, this.modul, this.submodul, this.menu, this.path, this.icon, this.seq, this.desc, this.is_active'
    },
    onsuccess(response) {
...
<template>
  <LayoutAuthenticated>
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiBallotOutline" title="Menu" main>
