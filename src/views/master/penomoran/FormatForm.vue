                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <FieldSelect :bind="{ disabled: !actionText, clearable: true }" class="w-full !mt-0"
                            ...
                            :errorText="formErrors.m_menu_id ? 'failed' : ''" :hints="formErrors.m_menu_id"
                            valueField="id" displayField="menu" :api="{
                    ...
                    <div>
                        ...
                        <FieldX :bind="{ readonly: true }" class="w-full !mt-0" :value="values.pratinjau"
                            :errorText="formErrors.pratinjau ? 'failed' : ''" :check="false" placeholder="Pratinjau"
                            label="" />
                    </div>
                </div>
                            ...
                            <tr v-if="detailArr.length > 0"
                                ...
                                <td class="px-6 py-4">
                                    <FieldSelect :bind="{ disabled: false, clearable: true }" class="w-full !mt-0"
                                        ...
                                        :hints="formErrors.generate_code_type_id" valueField="id" displayField="name"
                                        :api="{
