    ...
    <SectionMain>
      ...
      <CardBox>
        <div class="grid grid-cols-3 gap-4">
          ...
          <div>
            <label class="block font-semibold mb-2">Tipe Prefix</label>
            <FieldSelect
              :bind="{ disabled: !actionText, clearable: true }"
              class="w-full !mt-0"
              :value="values.ref_type"
              @input="(v) => (values.ref_type = v)"
              :errorText="formErrors.ref_type ? 'failed' : ''"
          ...
          <div>
            <label class="block font-semibold mb-2">Value</label>
            <FieldX
              :bind="{ readonly: !actionText }"
              class="w-full !mt-0"
              :value="values.value"
              :errorText="formErrors.value ? 'failed' : ''"
